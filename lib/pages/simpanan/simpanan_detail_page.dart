import 'package:bumaba/components/simpanan/tagihan_comp.dart';
import 'package:bumaba/components/transaksi/transaksi_list_item.dart';
...
import '../../controllers/simpanan_controller.dart';
...
class _SimpananDetailPageState extends StateMVC<SimpananDetailPage> {
  ...
  @override
  void initState() {
    _con.listenDetailSimpanan(slug: widget.routeArgument.param["slug"]);
    super.initState();
  }
