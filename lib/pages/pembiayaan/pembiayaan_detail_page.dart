...
import '../../models/pembiayaan_model.dart';
...
class _PembiayaanDetailPageState extends StateMVC<PembiayaanDetailPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    // print
    _con.listenPembiayaanListDetail(slug: widget.routeArgument.param["slug"]);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.routeArgument.param["program"],
      ...
      body: _con.listDetail == null ? CircularLoadingWidget(height: size.height/2): 
        SafeArea(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  Navigator.of(context).pushNamed('/PembiayaanBayar', arguments: new RouteArgument(id: widget.routeArgument.param["slug"]));
                                }, 
