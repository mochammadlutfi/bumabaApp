...
import 'package:bumaba/Modules/Notifikasi/notification_page.dart';
import 'package:bumaba/Modules/Transaksi/transaksi_page.dart';
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        //     onPressed: () {
        //       Navigator.of(context).pushNamed('/SimlaScan');
        //     },
